    ...
    def __init__(self, screen: pygame.Surface):
        ...
        def make_portal():
            ...
            if self.portal_gun.isHit:
                position = self.portal_gun.position
                ...
                if portal.is_valid_position(
                    ...
                    position = portal.fix_position(position, edge)
        ...
        self.renderings.append(self.portals[0].draw)
        self.renderings.append(self.portals[1].draw)
